...
class ScoreModel {
    ...
    public function updateWrongCount($question_id) {
    ...
    // Metode untuk menghapus score berdasarkan question_id
    public function deleteByQuestionId($question_id) {
        $query = "DELETE FROM score WHERE question_id = :question_id"; // Kuery untuk menghapus score berdasarkan question_id
        $stmt = $this->db->prepare($query); // Menyiapkan pernyataan
        $stmt->bindValue(':question_id', $question_id, PDO::PARAM_INT); // Mengikat nilai question_id
