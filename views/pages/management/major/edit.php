            ...
            <div class="col-lg-12">
                <div class="card m-b-30">
                    <div class="card-body">
                        ...
                        <form method="POST" action="<?= $_ENV['BASE_URL']; ?>/major/update/<?= $major['id'] ?>">
                            <div class="form-group">
                                <label>Major name</label>
                                <input type="text" class="form-control" id="major_name" 
                                    name="name" placeholder="Major name" value="<?= $major['name'] ?>" />
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="major_price" 
                                    name="price" placeholder="Major price" value="<?= $major['price'] ?>" />
