            ...
            <div class="col-lg-12">
                <div class="card m-b-30">
                    <div class="card-body">
                        ...
                        <form method="POST" action="<?= $_ENV['BASE_URL']; ?>/class/update/<?= $class['id'] ?>">
                            <div class="form-group">
                                <label>Class name</label>
                                <input type="text" class="form-control" id="class_name" 
                                    value="<?= $_SESSION['old']['name'] ?? $class['name'] ?>" name="name" placeholder="Class name" />
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="starting_roll_number" 
                                    value="<?= $_SESSION['old']['starting_roll_number'] ?? $class['starting_roll_number'] ?>" 
                                    name="starting_roll_number" placeholder="Starting roll number" disabled/>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="ending_roll_number" 
                                    value="<?= $_SESSION['old']['ending_roll_number'] ?? $class['ending_roll_number'] ?>" 
                                    name="ending_roll_number" placeholder="Ending roll number" disabled/>
